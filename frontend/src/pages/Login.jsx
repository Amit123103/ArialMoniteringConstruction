...
const Login = () => {
    const [email, setEmail] = useState('admin@aerialpm.com');
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 bg-grid-pattern bg-[length:32px_32px] overflow-hidden relative">
                ...
                <div className="glass-panel p-8 relative z-10 shadow-[0_0_50px_rgba(245,158,11,0.15)] border-amber-500/30">
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-900 border border-amber-500/50 mb-4 shadow-[0_0_25px_rgba(245,158,11,0.3)] group-hover:shadow-[0_0_35px_rgba(245,158,11,0.5)] transition-all">
                            <span className="text-2xl font-mono text-amber-500 animate-pulse">CV</span>
                        </div>
                        <h1 className="text-3xl font-display font-bold tracking-wider text-slate-100">AERIAL<span className="text-amber-500">PM</span></h1>
                        <p className="text-slate-400 font-mono text-sm mt-2">AI PROGRESS MONITORING SYSTEM</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="email" className="block text-xs font-mono text-amber-500/80 mb-2 uppercase tracking-widest">Operator ID</label>
                            <input
                                id="email"
                                name="email"
                                type="email"
                        ...
                        <div>
                            <label htmlFor="password" className="block text-xs font-mono text-amber-500/80 mb-2 uppercase tracking-widest">Access Code</label>
                            <input
                                id="password"
                                name="password"
                                type="password"
            ...
            <p className="fixed bottom-4 text-xs font-mono text-slate-600">v2.0 - TERMINAL_SECURE</p>
        </div>
    );
};
